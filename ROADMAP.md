...
| **Sprint 4 — Refactors estructurales** | 🟢 99% | 25 de 26 dominios migrados (96%). Solo queda venta (no es bug, ya tiene auth correcto desde Sprint 1; pendiente portar 8 sub-resources al module). 13 schemas Zod activos. PresupuestosPage 1010→744 LOC, 3 modales extraídos. Multer + storage adapter portados a modules/. |
